...
- **Viewer refinements.** Color-by-congestion (speed) toggle alongside color-by-type; truck/SkyTrain icons once demand includes those modes; window-on-demand trace loading as the scrubber moves (vs full upfront); glyph-icon polish.
